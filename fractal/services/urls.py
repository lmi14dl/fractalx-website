...
urlpatterns = [
    ...
    path('telergam-bot/order-form', views.telegram_bot_order_form_view, name='telegram_bot_order_form'),
    # trading tools
    path('trading/tutorial', views.trading_tutorial_view, name='trading_tutorial'),
    # ...
]